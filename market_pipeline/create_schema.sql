-- ============================================================
-- create_schema.sql
-- اجرا:  psql -d marketdb -f create_schema.sql
-- یا مستقیم در pgAdmin کپی و اجرا کن
--
-- این اسکریپت:
--   1) همه جداول را می‌سازد (اگر وجود ندارند)
--   2) Indexها و Foreign Keyها را اضافه می‌کند
--   3) مقادیر ثابت dim tableها را seed می‌کند
-- ============================================================


-- ============================================================
-- بخش ۱: DIMENSION TABLES (جداول مرجع)
-- ============================================================
